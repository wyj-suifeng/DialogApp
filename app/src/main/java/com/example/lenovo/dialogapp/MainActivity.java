...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnt = (Button) this.findViewById(R.id.buttonTest);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final View dia = inflater.inflate(R.layout.login_dialog, null);
                builder.setView(dia)
                        .setTitle("Login")
                        // Add action buttons
                        .setPositiveButton(R.string.login, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int id) {
                                // login
                                EditText user = (EditText) dia.findViewById(R.id.t1);
                                EditText pw = (EditText) dia.findViewById(R.id.t2);
